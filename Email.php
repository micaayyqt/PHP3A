...
function sendMail($email, $subject, $message) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'micaellamillos@gmail.com';  // Your email
        $mail->Password = 'fvhx bspc blcw saij';        // Your email password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Sender and recipient settings
        $mail->setFrom('micaellamillos@gmail.com', 'Micaella Millos');
